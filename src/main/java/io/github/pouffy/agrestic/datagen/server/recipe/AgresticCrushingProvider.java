...
public class AgresticCrushingProvider extends AgresticRecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        recipe(new FluidStack(AgresticFluids.APPLE_JUICE, 250), Ingredient.of(Items.APPLE), new ChanceResult(new ItemStack(AgresticBlocks.APPLE_SEEDS), 1), output, "apple");
        recipe(new FluidStack(KrystalCore.HONEY, 250), Ingredient.of(Items.HONEYCOMB), output, "honeycomb");
        recipe(new FluidStack(AgresticFluids.GOLDEN_APPLE_JUICE, 100), Ingredient.of(Items.GOLDEN_APPLE), new ChanceResult(new ItemStack(AgresticBlocks.APPLE_SEEDS), 1), output, "golden_apple");
