...
public class AgresticTreeGrowers {
    ...
    public static final TreeGrower APPLE = new TreeGrower(Agrestic.MODID + ":apple", Optional.empty(), Optional.of(AgresticConfiguredFeatures.APPLE_TREE), Optional.empty());
}
